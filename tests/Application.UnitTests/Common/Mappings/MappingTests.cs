...
using CaSln.Application.Common.Models;
using CaSln.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using CaSln.Application.TodoLists.Queries.GetTodos;
using CaSln.Domain.Entities;
using NUnit.Framework;

namespace CaSln.Application.UnitTests.Common.Mappings;
